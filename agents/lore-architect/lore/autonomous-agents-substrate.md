...
- `agent-being-consciousness-substrate-split.md` — the switchboard daemon sketched here is the precedent generalized by the Being Keeper (Lore Beings, design settled 2026-07-19; see `lore-beings-design.md`): deterministic substrate, never an LLM, for scheduling/spawning/monitoring/budget
