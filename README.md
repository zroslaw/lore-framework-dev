...
- [`tests/`](tests/) — deterministic tests, standard real-engine lifecycle tests, separate Lore Beings lifecycle tests, and quality benchmarks.
...
Lore Beings lifecycle source files:

- [`tests/lifecycle_beings/run_matrix.py`](tests/lifecycle_beings/run_matrix.py) — separate Lore Beings lifecycle matrix runner.
- [`tests/lifecycle_beings/keeper_harness.py`](tests/lifecycle_beings/keeper_harness.py) — Being Keeper lifecycle harness.
- [`tests/lifecycle_beings/test_lrb_lifecycle.py`](tests/lifecycle_beings/test_lrb_lifecycle.py)
...
Lore Beings lifecycle tests are separate, higher-blast-radius, and also gated:
...
Standard lifecycle matrix runs write:
...
- `logs/` — per-engine/module stdout/stderr.
- `debug/` — per-engine/module debug captures when enabled.

Lore Beings lifecycle matrix runs write:

```text
tests/lifecycle_beings/results/
```

with the same lifecycle matrix artifact shape: `summary.json`, `logs/`, and optional `debug/`.
