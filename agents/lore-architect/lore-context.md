...
— cursor engine kind added locally (`142cbba`, not pushed); full lifecycle suite and live cursor
Keeper e2e (`test_lrb_cursor_real_e2e.py`, needs `cursor-agent login`) still owed. See Autonomous
