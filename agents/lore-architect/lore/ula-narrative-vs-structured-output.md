...
Realization that motivated the codex's `index.md` aspect (2026-06-03).
...
**Resolution:** this is the "context" aspect, captured in the per-file `index.md` in the codex. See `codex-per-repo-mirror.md`. Related: `aiqa-ula-feature.md`, `ula-validated-turbo-boost-switcher.md`.
